// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR2002InternalInterfacesMustHaveXMLComment.cs" company="Michael Reukauff, Germany">
...
namespace CommentCop.Interfaces
{
    ...
    public class MR2002InternalInterfacesMustHaveXMLComment : DiagnosticAnalyzer
    {
        ...
        /// <summary>
        /// The help link (const). Value: "https://github.com/mreu/CommentCop/blob/master/Documentation/MR2002.md".
        /// </summary>
        private const string HelpLink = "https://github.com/mreu/CommentCop/blob/master/Documentation/MR2002.md";
