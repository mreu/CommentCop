// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR2003MethodDefinitionsInInterfacesMustHaveXMLComment.cs" company="Michael Reukauff, Germany">
...
namespace CommentCop.Interfaces
{
    ...
    {
        /// <summary>
        /// The diagnostic id (const). Value: Constants.DiagnosticPrefix + "2003".
        /// </summary>
        ...
        /// <summary>
        /// The title (const). Value: "Method definitions in interfaces" + Constants.MustHaveXmlHeader.
        /// </summary>
        ...
        /// <summary>
        /// The help link (const). Value: "https://github.com/mreu/CommentCop/blob/master/Documentation/MR2003.md".
        /// </summary>
        private const string HelpLink = "https://github.com/mreu/CommentCop/blob/master/Documentation/MR2003.md";
