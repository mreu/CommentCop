// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR2003CodeFixProvider.cs" company="Michael Reukauff, Germany">
...
namespace CommentCop.Interfaces
{
    ...
    public class MR2003CodeFixProvider : CodeFixProvider
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                Debug.WriteLine($"{nameof(MR2003CodeFixProvider)} - Exception on {identifierToken} = {exp.Message}");
