// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR2001PublicInterfacesMustHaveXMLComment.cs" company="Michael Reukauff, Germany">
...
namespace CommentCop.Interfaces
{
    ...
    public class MR2001PublicInterfacesMustHaveXMLComment : DiagnosticAnalyzer
    {
        ...
        /// <summary>
        /// The help link (const). Value: "https://github.com/mreu/CommentCop/blob/master/Documentation/MR2001.md".
        /// </summary>
        private const string HelpLink = "https://github.com/mreu/CommentCop/blob/master/Documentation/MR2001.md";
