// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR7001CodeFixProvider.cs" company="Michael Reukauff, Germany">
...
namespace CommentCop.Regions
{
    ...
    public class MR7001CodeFixProvider : CodeFixProvider
    {
        ...
        /// The title.
        /// </summary>
        public const string Title = "Make description of #region beginning with uppercase characters (MR7001)";
