// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR7012CodeFixProvider.cs" company="Michael Reukauff, Germany">
...
namespace CommentCop.Regions
{
    ...
    /// <summary>
    /// The MR7012Code fix provider class.
    /// </summary>
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(MR7012CodeFixProvider))]
    [Shared]
    public class MR7012CodeFixProvider : CodeFixProvider
    {
        /// <summary>
        /// The title.
        /// </summary>
        private const string Title = "Insert empty line following #endregion. (MR7012)";

        /// <summary>
        /// Gets the fixable diagnostic ids.
        /// </summary>
        public sealed override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(MR7012EmptyLineMustFollowingEndRegionKeyword.DiagnosticId7012);
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (!identifierToken.LeadingTrivia.Any(x => x.IsKind(SyntaxKind.EndRegionDirectiveTrivia)))
                {
                    return document;
                }
            ...
            {
                Debug.WriteLine($"{nameof(MR7012CodeFixProvider)} - Exception = {exp.Message}");
