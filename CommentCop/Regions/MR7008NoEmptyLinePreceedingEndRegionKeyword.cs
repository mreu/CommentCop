// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR7008NoEmptyLinePreceedingEndRegionKeyword.cs" company="Michael Reukauff, Germany">
...
namespace CommentCop.Regions
{
    ...
    public class MR7008NoEmptyLinePreceedingEndRegionKeyword : DiagnosticAnalyzer
    {
        ...
        /// <summary>
        /// The help link (const). Value: "https://github.com/mreu/CommentCop/blob/master/Documentation/MR7008.md".
        /// </summary>
        private const string HelpLink = "https://github.com/mreu/CommentCop/blob/master/Documentation/MR7008.md";
