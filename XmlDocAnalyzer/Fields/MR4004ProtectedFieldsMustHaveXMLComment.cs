// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR4004ProtectedFieldsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Fields
{
    ...
    /// <summary>
    /// MR4004 protected fields must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR4004ProtectedFieldsMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR4004";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Protected fields must have a xml documentation header.";
