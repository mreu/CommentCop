// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR4001PublicFieldsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Fields
{
    ...
    public class MR4001PublicFieldsMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR4001";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Public fields must have a xml documentation header.";
