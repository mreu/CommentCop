// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR4003InternalProtectedFieldsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Fields
{
    ...
    /// <summary>
    /// MR4003 internal protected fields must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR4003InternalProtectedFieldsMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR4003";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Internal protected fields must have a xml documentation header.";
