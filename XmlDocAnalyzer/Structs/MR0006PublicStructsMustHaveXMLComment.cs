// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR0006PublicStructsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Structs
{
    ...
    public class MR0006PublicStructsMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR0006";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Public structs must have a xml documentation header.";
