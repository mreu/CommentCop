// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR5002InternalEventsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Events
{
    ...
    /// <summary>
    /// MR5002 internal events must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR5002InternalEventsMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR5002";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Internal events must have a xml documentation header.";
