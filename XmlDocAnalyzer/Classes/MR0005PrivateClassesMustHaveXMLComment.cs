// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR0005PrivateClassesMustHaveXMLComment.cs" author="Michael Reukauff">
...
namespace XmlDocAnalyzer.Classes
{
    ...
    /// <summary>
    /// MR0005 private classes must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR0005PrivateClassesMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        ...
        /// The title.
        /// </summary>
        private const string Title = "Private classes must have a xml documentation header.";
