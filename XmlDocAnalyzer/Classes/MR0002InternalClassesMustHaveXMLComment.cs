// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR0002InternalClassesMustHaveXMLComment.cs" author="Michael Reukauff">
...
namespace XmlDocAnalyzer.Classes
{
    ...
    /// <summary>
    /// MR0002 internal classes must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR0002InternalClassesMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        ...
        /// The title.
        /// </summary>
        private const string Title = "Internal classes must have a xml documentation header.";
