// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR0003InternalProtectedClassesMustHaveXMLComment.cs" author="Michael Reukauff">
...
namespace XmlDocAnalyzer.Classes
{
    ...
    /// <summary>
    /// MR0003 internal protected classes must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR0003InternalProtectedClassesMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        ...
        /// The title.
        /// </summary>
        private const string Title = "Internal protected classes must have a xml documentation header.";
