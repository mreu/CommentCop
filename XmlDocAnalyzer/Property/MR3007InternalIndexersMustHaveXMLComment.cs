// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR3007InternalIndexersMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Property
{
    ...
    /// <summary>
    /// MR3007 internal indexers must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR3007InternalIndexersMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR3007";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Internal indexers must have a xml documentation header.";
