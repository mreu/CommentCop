// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR3009ProtectedIndexersMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Property
{
    ...
    /// <summary>
    /// MR3009 protected indexers must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR3009ProtectedIndexersMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR3009";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Protected indexers must have a xml documentation header.";
