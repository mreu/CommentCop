// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR3005PrivatePropertiesMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Property
{
    ...
    /// <summary>
    /// MR3005 private properties must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR3005PrivatePropertiesMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR3005";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Private properties must have a xml documentation header.";
