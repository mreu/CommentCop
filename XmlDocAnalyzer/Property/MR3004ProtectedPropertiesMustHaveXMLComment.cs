// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR3004ProtectedPropertiesMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Property
{
    ...
    /// <summary>
    /// MR3004 protected properties must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR3004ProtectedPropertiesMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR3004";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Protected properties must have a xml documentation header.";
