// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR1002InternalMethodsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Methods
{
    ...
    /// <summary>
    /// MR1002 internal methods must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR1002InternalMethodsMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR1002";
