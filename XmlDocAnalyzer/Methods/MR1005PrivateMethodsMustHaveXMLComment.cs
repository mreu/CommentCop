// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR1005PrivateMethodsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Methods
{
    ...
    /// <summary>
    /// MR1005 private methods must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR1005PrivateMethodsMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR1005";
