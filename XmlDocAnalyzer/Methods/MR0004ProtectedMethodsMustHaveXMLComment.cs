// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR0004ProtectedMethodsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Methods
{
    ...
    public class MR0004 : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = nameof(MR0004);
        ...
        /// The message.
        /// </summary>
        private static readonly string Message = $"Protected methods must have a xml documentation header ({DiagnosticId}).";
        ...
        /// The description.
        /// </summary>
        private const string Description = "Protected methods must have a xml documentation header.";
