...
namespace XmlDocAnalyzer.Methods
{
    ...
    public class MR0005 : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = nameof(MR0005);
        ...
        /// The message.
        /// </summary>
        private static readonly string Message = $"Private methods must have a xml documentation header ({DiagnosticId}).";
        ...
        /// The description.
        /// </summary>
        private const string Description = "Private methods must have a xml documentation header.";
