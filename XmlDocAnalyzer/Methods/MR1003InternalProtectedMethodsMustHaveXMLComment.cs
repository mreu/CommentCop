// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR1003InternalProtectedMethodsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Methods
{
    ...
    /// <summary>
    /// MR1003 internal protected methods must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR1003InternalProtectedMethodsMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR1003";
