// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR7001PublicDelegatesMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Delegates
{
    ...
    public class MR7001PublicDelegatesMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR7001";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Public delegates must have a xml documentation header.";
