// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR7003InternalProtectedDelegatesMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Delegates
{
    ...
    /// <summary>
    /// MR7003 internal protected delegates must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR7003InternalProtectedDelegatesMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR7003";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Internal protected delegates must have a xml documentation header.";
