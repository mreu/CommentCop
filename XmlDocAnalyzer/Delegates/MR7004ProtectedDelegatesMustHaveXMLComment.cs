// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR7004ProtectedDelegatesMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Delegates
{
    ...
    /// <summary>
    /// MR7004 protected delegates must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR7004ProtectedDelegatesMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR7004";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Protected delegates must have a xml documentation header.";
