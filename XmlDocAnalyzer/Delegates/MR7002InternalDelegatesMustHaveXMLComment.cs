// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR7002InternalDelegatesMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Delegates
{
    ...
    /// <summary>
    /// MR7002 internal delegates must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR7002InternalDelegatesMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR7002";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Internal delegates must have a xml documentation header.";
