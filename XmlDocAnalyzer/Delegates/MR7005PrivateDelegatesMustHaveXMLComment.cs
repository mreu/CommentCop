// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR7005PrivateDelegatesMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Delegates
{
    ...
    /// <summary>
    /// MR7005 private delegates must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR7005PrivateDelegatesMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR7005";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Private delegates must have a xml documentation header.";
