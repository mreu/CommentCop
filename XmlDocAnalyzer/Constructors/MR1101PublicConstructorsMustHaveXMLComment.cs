// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR1101PublicConstructorsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Constructors
{
    ...
    public class MR1101PublicConstructorsMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR1101";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Public constructors must have a xml documentation header.";
