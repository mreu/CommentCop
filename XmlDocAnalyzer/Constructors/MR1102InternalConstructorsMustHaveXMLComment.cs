// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR1102InternalConstructorsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Constructors
{
    ...
    /// <summary>
    /// MR1102 internal constructors must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR1102InternalConstructorsMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR1102";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Internal constructors must have a xml documentation header.";
