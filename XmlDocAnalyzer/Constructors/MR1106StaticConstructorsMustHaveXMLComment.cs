// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR1106StaticConstructorsMustHaveXMLComment.cs" company="Michael Reukauff">
...
namespace XmlDocAnalyzer.Constructors
{
    ...
    /// <summary>
    /// MR1106 static constructors must have XML comment.
    /// </summary>
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MR1106StaticConstructorsMustHaveXMLComment : DiagnosticAnalyzer
    {
        /// <summary>
        /// The diagnostic id.
        /// </summary>
        public const string DiagnosticId = "MR1106";
        ...
        /// The title.
        /// </summary>
        private const string Title = "Static constructors must have a xml documentation header.";
