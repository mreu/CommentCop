// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR1006CodeFixProvider.cs" company="Michael Reukauff">
//   Copyright © 2016 Michael Reukauff. All rights reserved.
// </copyright>
// --------------------------------------------------------------------------------------------------------------------

namespace XmlCommenter.Methods
{
    using System;
    ...
    [Shared]
    public class MR1006CodeFixProvider : CodeFixProvider
    {
        /// <summary>
        /// The title.
        /// </summary>
            ...
            CancellationToken cancellationToken)
        {
            ...
            var declaration = (OperatorDeclarationSyntax)identifierToken.Parent;
