// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR7006CodeFixProvider.cs" author="Michael Reukauff">
...
namespace XmlCommenter.Regions
{
    ...
    /// <summary>
    /// The MR7006 code fix provider class.
    /// </summary>
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(MR7006CodeFixProvider))]
    [Shared]
    public class MR7006CodeFixProvider : CodeFixProvider
    {
        /// <summary>
        /// The title.
        /// </summary>
        private const string Title = "Fix spacing. (MR7006)";

        /// <summary>
        /// Gets the fixable diagnostic ids.
        /// </summary>
        public sealed override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(MR7006NoMultipleWhitespacesFollowingTheEndregionKeyword.DiagnosticId7006);
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                Debug.WriteLine($"{nameof(MR7006CodeFixProvider)} - Exception on {identifierToken} = {exp.Message}");
