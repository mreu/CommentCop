// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MR1201CodeFixProvider.cs" company="Michael Reukauff">
//   Copyright © 2016 Michael Reukauff. All rights reserved.
// </copyright>
// --------------------------------------------------------------------------------------------------------------------

namespace XmlCommenter.Destructors
{
    using System;
    ...
    public class MR1201CodeFixProvider : CodeFixProvider
    {
        ...
        /// </summary>
        public sealed override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(MR1201DestructorsMustHaveXMLComment.DiagnosticId);
            ...
            CancellationToken cancellationToken)
        {
            ...
            var declaration = (DestructorDeclarationSyntax)identifierToken.Parent;
            ...
            {
                Debug.WriteLine($"{nameof(MR1201CodeFixProvider)} - Exception on {identifierToken} = {exp.Message}");
        ...
        private static DocumentationCommentTriviaSyntax GetSummary(DestructorDeclarationSyntax theSyntaxNode)
        {
            var summaryComment = $" Finalizes an instance of the <see cref=\"{theSyntaxNode.Identifier.ValueText}\"/> class.";
