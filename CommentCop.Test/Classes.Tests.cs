// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Classes.Tests.cs" company="Michael Reukauff, Germany">
...
namespace CommentCop.Test
{
    ...
    /// <summary>
    /// Test all classes analyzers and code fixes.
    /// </summary>
    [TestClass]
